...
public enum SchematicSystem implements ISchematicSystem {
  ...
  @Override
  public Registry<ISchematicFormat> getRegistry() { return this.registry; }
  ...
  @Override
  public List<String> getFileExtensions() { return this.registry.stream().map(ISchematicFormat::getFileExtensions).flatMap(List::stream).toList(); }
}
