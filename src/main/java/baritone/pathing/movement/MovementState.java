...
public class MovementState {
  ...
  public MovementTarget getTarget() { return this.target; }
  ...
  public Map<Input, Boolean> getInputStates() { return this.inputState; }
  ...
  public static class MovementTarget {
    ...
    public final Optional<Rotation> getRotation() { return Optional.ofNullable(this.rotation); }
