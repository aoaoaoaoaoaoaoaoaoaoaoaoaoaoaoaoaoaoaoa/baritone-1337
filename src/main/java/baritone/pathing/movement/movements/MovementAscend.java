...
public class MovementAscend extends Movement {
  ...
  public static double cost(CalculationContext context, int x, int y, int z, int destX, int destZ) {
    return cost(context, null, x, y, z, destX, destZ);
  }
  ...
  public static double cost(CalculationContext context, NodeTerrainFacts facts, int x, int y, int z, int destX, int destZ) {
    ...
    if (!MovementHelper.canWalkOn(context, destX, y, destZ, toPlace)) {
      ...
      if (!context.affordances.replaceable(destX, y, destZ, toPlace)) {
        return COST_INF;
      }
    ...
    if ((hasFacts && facts.srcDownLadderOrVine) || (!hasFacts && (srcDown.getBlock() == Blocks.LADDER || srcDown.getBlock() == Blocks.VINE))) {
      return COST_INF;
    }
