...
public class DefaultArgParsers {
  ...
  public enum IntArgumentParser implements IArgParser.Stateless<Integer> {
    ...
    @Override
    public Class<Integer> getTarget() { return Integer.class; }
  ...
  public enum LongArgumentParser implements IArgParser.Stateless<Long> {
    ...
    @Override
    public Class<Long> getTarget() { return Long.class; }
  ...
  public enum FloatArgumentParser implements IArgParser.Stateless<Float> {
    ...
    @Override
    public Class<Float> getTarget() { return Float.class; }
  ...
  public enum DoubleArgumentParser implements IArgParser.Stateless<Double> {
    ...
    @Override
    public Class<Double> getTarget() { return Double.class; }
  ...
  public static class BooleanArgumentParser implements IArgParser.Stateless<Boolean> {
    ...
    @Override
    public Class<Boolean> getTarget() { return Boolean.class; }
  ...
  public static final List<IArgParser<?>> ALL =
    Arrays.asList(IntArgumentParser.INSTANCE, LongArgumentParser.INSTANCE, FloatArgumentParser.INSTANCE, DoubleArgumentParser.INSTANCE, BooleanArgumentParser.INSTANCE);
}
