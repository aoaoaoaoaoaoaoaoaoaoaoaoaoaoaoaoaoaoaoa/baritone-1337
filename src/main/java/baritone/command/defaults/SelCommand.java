...
public class SelCommand extends Command {
  ...
  @Override
  public String getShortDesc() { return "WorldEdit-like commands"; }
  ...
  enum TransformTarget {
    ALL(sels -> sels, "all", "a"), NEWEST(sels -> new ISelection[]{sels[sels.length - 1]}, "newest", "n"), OLDEST(sels -> new ISelection[]{sels[0]}, "oldest", "o");
