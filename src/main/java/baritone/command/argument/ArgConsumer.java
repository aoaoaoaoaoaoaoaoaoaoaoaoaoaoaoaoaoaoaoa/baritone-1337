...
public class ArgConsumer implements IArgConsumer {
  ...
  @Override
  public LinkedList<ICommandArgument> getArgs() { return this.args; }

  @Override
  public Deque<ICommandArgument> getConsumed() { return this.consumed; }
  ...
  @Override
  public String getString() throws CommandNotEnoughArgumentsException { return get().getValue(); }
  ...
  private final class Context implements IDatatypeContext {
    ...
    @Override
    public final IBaritone getBaritone() { return ArgConsumer.this.manager.getBaritone(); }

    @Override
    public final ArgConsumer getConsumer() { return ArgConsumer.this; }
  }
}
