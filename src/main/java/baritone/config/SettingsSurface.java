    ...
    return List.of(
        ...
        new Category("Pathing",
            List.of(entry("Chunk cache", s.chunkCaching, "Remember simplified chunk knowledge."), entry("Cached-only paths", s.pathThroughCachedOnly, "Do not query live world beyond cache."),
                ...
                entry("Plan-ahead fail ms", s.planAheadFailureTimeoutMS, "Failure timeout for next segment."),
                entry("Movement timeout ticks", s.movementTimeoutTicks, "Executor timeout per movement."), entry("Path cutoff factor", s.pathCutoffFactor, "Static path suffix cutoff."),
                entry("Plan-ahead ticks", s.planningTickLookahead, "When to begin next-segment planning."))),
        new Category("Render",
        ...
        new Category("Elytra",
            List.of(entry("Auto jump", s.elytraAutoJump, "Walk to ledges and launch automatically."), entry("Predict terrain", s.elytraPredictTerrain, "Use nether seed terrain prediction."),
                entry("Nether seed", s.elytraNetherSeed, "Seed for nether terrain prediction."), entry("Conserve fireworks", s.elytraConserveFireworks, "Avoid fireworks while descending."),
                entry("Firework speed", s.elytraFireworkSpeed, "Minimum speed before boosting."), entry("Auto swap elytra", s.elytraAutoSwap, "Swap damaged elytra automatically."),
                entry("Minimum durability", s.elytraMinimumDurability, "Swap/land durability threshold."),
