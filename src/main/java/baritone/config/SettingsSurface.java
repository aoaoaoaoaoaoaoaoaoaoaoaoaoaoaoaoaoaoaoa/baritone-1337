    ...
    return List.of(
      ...
      new Category("Pathing",
        List.of(entry("Chunk cache", s.chunkCaching, "Use, pack, and save simplified chunk facts."), entry("Cached-only paths", s.pathThroughCachedOnly, "Do not use live chunks as pathing facts."),
          ...
          entry("Farfield commit ticks", s.farfieldMinCommittedPrefixTicks, "Committed pedestrian prefix before Farfield freshness may preempt."),
          entry("Farfield refresh replan", s.farfieldRefreshPhysicalReplan, "Allow refreshed Farfield values to replan an executing pedestrian route."),
          entry("Farfield preempt ticks", s.farfieldPhysicalPreemptMinImprovementTicks, "Absolute Farfield-guided preemption margin."),
          entry("Farfield preempt ratio", s.farfieldPhysicalPreemptMinImprovementRatio, "Relative Farfield-guided preemption margin."),
