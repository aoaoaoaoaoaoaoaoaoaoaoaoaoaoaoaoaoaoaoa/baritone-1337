    ...
    return List.of(
      ...
      new Category("Pathing",
        List.of(entry("Chunk cache", s.chunkCaching, "Use, pack, and save simplified chunk facts."), entry("Cached-only paths", s.pathThroughCachedOnly, "Do not use live chunks as pathing facts."),
          ...
          entry("Macro planning", s.macroPlanning, "Enable route-level candidate producers, including water when a boat is available."),
          entry("Macro biome", s.macroBiome, "Enable empirical-biome route guidance."), entry("Biome priors", s.macroBiomePriorsFile, "Measured biome traversal prior table."),
          entry("Biome facts", s.macroBiomeFactsFile, "Chunk-biome fact atlas."), entry("Biome horizon", s.macroBiomeHorizonBlocks, "Search radius for empirical-biome macro planning."),
