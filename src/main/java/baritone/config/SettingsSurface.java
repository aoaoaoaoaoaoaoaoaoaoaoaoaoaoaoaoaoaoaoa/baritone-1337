  ...
  public static List<Category> categories() {
    ...
    return List.of(
      ...
      new Category("Render", List.of(entry("Render path", s.renderPath, "Draw current and next path."), entry("Path as line", s.renderPathAsLine, "Draw line path instead of boxes."),
        ...
        entry("Macro anchors", s.renderMacroPlanAnchors, "Draw macro launch, landing, and terminal anchors."),
        entry("Macro live color", s.colorMacroLivePlan, "Macro cells grounded in loaded chunks."), entry("Macro cache color", s.colorMacroCachedPlan, "Macro cells grounded in cached facts."),
