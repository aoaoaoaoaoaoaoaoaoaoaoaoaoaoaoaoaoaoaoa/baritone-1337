...
public class GoalRunAway implements Goal {
  ...
  public boolean equals(Object o) {
    ...
    return distanceSq == goal.distanceSq && Arrays.equals(from, goal.from) && Objects.equals(maintainY, goal.maintainY);
  }
  ...
  public String toString() {
    if (maintainY != null) {
      return String.format("GoalRunAwayFromMaintainY y=%s, %s", SettingsUtil.maybeCensor(maintainY), Arrays.asList(from));
    } else {
