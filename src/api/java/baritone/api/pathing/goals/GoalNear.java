...
public class GoalNear implements Goal, IGoalRenderPos {
  ...
  @Override
  public BlockPos getGoalPos() { return new BlockPos(x, y, z); }
  ...
  public String toString() {
    return String.format("GoalNear{x=%s, y=%s, z=%s, rangeSq=%d}", SettingsUtil.maybeCensor(x), SettingsUtil.maybeCensor(y), SettingsUtil.maybeCensor(z), rangeSq);
  }
}
