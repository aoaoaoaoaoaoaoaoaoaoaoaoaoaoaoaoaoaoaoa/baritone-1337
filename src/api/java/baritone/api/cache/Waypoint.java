...
public class Waypoint implements IWaypoint {
  ...
  @Override
  public BetterBlockPos getLocation() { return this.location; }

  @Override
  public String toString() {
    return String.format("%s %s %s", name, BetterBlockPos.from(location).toString(), new Date(creationTimestamp).toString());
  }
