...
public enum RelativeGoalBlock implements IDatatypePost<GoalBlock, BetterBlockPos> {
  ...
  public GoalBlock apply(IDatatypeContext ctx, BetterBlockPos origin) throws CommandException {
    ...
    return new GoalBlock(Mth.floor(consumer.getDatatypePost(RelativeCoordinate.INSTANCE, (double) origin.x)), Mth.floor(consumer.getDatatypePost(RelativeCoordinate.INSTANCE, (double) origin.y)),
